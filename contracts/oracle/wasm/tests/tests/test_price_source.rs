...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","uosmo"], "uosmo", None, false, 5, 100, [145692686804, 175998046105], &[6,6]; "Concentrated duality orderbook, base_denom in pair")]
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","uion"], "uosmo", Some(TWO), true, 5, 100, [145692686804, 175998046105], &[6,6]; "Concentrated duality orderbook, non-base asset in pair")]
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","uosmo"], "USD", None, false, 5, 100, [145692686804, 175998046105], &[6,6] => panics "pair does not contain base denom and no price source is configured for the other denom"; "Concentrated duality orderbook, base_denom not in pair, no source for other asset")]
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","uosmo"], "uosmo", None, false, 5, 100, [145692686804, 175998046105], &[6,8]; "Concentrated duality orderbook, base_denom in pair, 6:8 decimals")]
...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["usttia","utia"], Some(Decimal::from_ratio(5242u128, 10u128)), [145692686804, 175998046105], 10, 200, true, true; "Concentrated-duality-orderbook, staleness valid, rr gt twap")]
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["usttia","utia"], Some(Decimal::from_ratio(5242u128, 10u128)), [145692686804, 175998046105], 10, 200, true, false; "Concentrated-duality-orderbook, staleness valid, rr lt twap")]
...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], Some(Decimal::from_str("8.86506356").unwrap()), Some(Decimal::from_str("0.97696221").unwrap()), [1171210862745u128, 12117922358503u128], &[6,6], Some(Decimal::from_str("5.88585833583172000").unwrap()); "PCL duality orderbook, 6:6 decimals")]
#[test_case(PairType::Custom("concentrated".to_string()), &["uatom","untrn"], Some(Decimal::from_str("821123123435412349.73564").unwrap()), Some(Decimal::from_str("0.97696221").unwrap()), [90u128, 9000000000000000000u128], &[6,6], Some(Decimal::from_str("1791319358").unwrap()); "PCL, [6, 6] decimals Uint128 overflow")]
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], Some(Decimal::from_str("821123123435412349.73564").unwrap()), Some(Decimal::from_str("0.97696221").unwrap()), [90u128, 9000000000000000000u128], &[6,6], Some(Decimal::from_str("1791319358").unwrap()); "PCL duality orderbook, [6, 6] decimals Uint128 overflow")]
#[test_case(PairType::Custom("concentrated".to_string()), &["uatom","untrn"], Some(Decimal::from_str("0.000000000585").unwrap()), Some(Decimal::from_str("0.0000000097696221").unwrap()), [20000000000u128, 1000000000u128], &[6,6], Some(Decimal::from_str("0.00000000478137514").unwrap()); "PCL, [6, 6] decimals, rounding small numbers")]
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], Some(Decimal::from_str("0.000000000585").unwrap()), Some(Decimal::from_str("0.0000000097696221").unwrap()), [20000000000u128, 1000000000u128], &[6,6], Some(Decimal::from_str("0.00000000478137514").unwrap()); "PCL duality orderbook, [6, 6] decimals, rounding small numbers")]
#[test_case(PairType::Custom("concentrated".to_string()), &["udydx","untrn"], Some(Decimal::from_str("3000").unwrap()), Some(Decimal::from_str("0.97696221").unwrap()), [9000000000000000u128, 10000000000000000000u128], &[18,6], Some(Decimal::from_str("108275327").unwrap()); "PCL, [18, 6] decimals")]
...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], None, Some(Decimal::one()), [1171210862745u128, 1171210862745u128], &[6,6], None => panics "Invalid price source: missing price source for uatom"; "PCL duality orderbook, missing price source for first asset")]
...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], Some(Decimal::one()), None, [1171210862745u128, 1171210862745u128], &[6,6], None => panics "Invalid price source: missing price source for untrn"; "PCL duality orderbook, missing price source for second asset")]
...
#[test_case(PairType::Stable{}, &["uatom","untrn"], Some(Decimal::from_str("821123123432349.73564").unwrap()), Some(Decimal::from_str("721123123432349.73564").unwrap()), [9137529367457u128, 12117922358503u128], &[6,6], Some(Decimal::from_str("721123123432349.0000000000000000").unwrap()); "SS, [6, 6] decimals Uint128 overflow")]
...
#[test_case(PairType::Stable{}, &["uatom","untrn"], Some(Decimal::from_str("0.000000000585").unwrap()), Some(Decimal::from_str("0.0000000097696221").unwrap()), [1000000000u128, 100000000u128], &[6,6], None => panics "LP price diff too large"; "SS, lp price diff too large")]
