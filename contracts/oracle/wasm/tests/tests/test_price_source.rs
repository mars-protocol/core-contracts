...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], Some(Decimal::from_str("821123123435412349.73564").unwrap()), Some(Decimal::from_str("0.97696221").unwrap()), [923752936745723845u128, 12117922358503u128], &[6,6], Some(Decimal::from_str("1791319358").unwrap()); "PCL duality orderbook, [6, 6] decimals Uint128 overflow")]
...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["uatom","untrn"], Some(Decimal::from_str("0.000000000585").unwrap()), Some(Decimal::from_str("0.0000000097696221").unwrap()), [34567u128, 67891u128], &[6,6], Some(Decimal::from_str("0.00000000478137514").unwrap()); "PCL duality orderbook, [6, 6] decimals, rounding small numbers")]
...
#[test_case(PairType::Custom("concentrated_duality_orderbook".to_string()), &["udydx","untrn"], Some(Decimal::from_str("3000").unwrap()), Some(Decimal::from_str("0.97696221").unwrap()), [92347562936745723845u128, 12117922358503u128], &[18,6], Some(Decimal::from_str("108275327").unwrap()); "PCL duality orderbook, [18, 6] decimals")]
