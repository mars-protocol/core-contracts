...
use crate::{
    ...
    state::{
        ACCOUNT_NFT, DUALITY_SWAPPER, HEALTH_CONTRACT, INCENTIVES, KEEPER_FEE_CONFIG, MAX_SLIPPAGE, MAX_TRIGGER_ORDERS, MAX_UNLOCKING_POSITIONS, ORACLE, OWNER, PARAMS, PERPS, PERPS_LB_RATIO, RED_BANK, REWARDS_COLLECTOR, SWAPPER, SWAP_FEE, ZAPPER
    },
...
pub fn update_config(
    ...
    if let Some(num) = updates.swap_fee {
        ...
        response = response.add_attribute("key", "swap_fee").add_attribute("value", num.to_string());
    }
