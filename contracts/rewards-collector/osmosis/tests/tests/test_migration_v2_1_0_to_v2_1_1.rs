...
use mars_types::rewards_collector::{OsmosisMigrateMsg, TransferType};
...
fn wrong_contract_name() {
    ...
    let err = migrate(deps.as_mut(), mock_env(), OsmosisMigrateMsg::V2_1_0ToV2_1_1 {}).unwrap_err();
...
fn successful_migration_to_v2_1_1() {
    ...
    let res = migrate(deps.as_mut(), mock_env(), OsmosisMigrateMsg::V2_1_0ToV2_1_1 {}).unwrap();
