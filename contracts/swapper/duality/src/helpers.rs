...
use neutron_sdk::{bindings::msg::NeutronMsg, proto_types::neutron::dex::MsgPlaceLimitOrder, stargate::{aux::create_stargate_msg, dex::types::PlaceLimitOrderRequest}};
...
mod tests {
    ...
    fn test_serialize_prec_dec() {
        ...
        assert_eq!(
            serialize_prec_dec("1.2300".to_string()),
            "1230000000000000000000000000"
        );
        
        // Case with long fractional part
        assert_eq!(
            serialize_prec_dec("0.000123".to_string()),
