...
//     // Filter assetParams
//     const filteredAssetParams = new Map<string, AssetParamsBaseForString>()
//     for (const [denom, params] of assetParams.entries()) {
//       if (!excludedDenoms.has(denom)) {
//         filteredAssetParams.set(denom, params)
//       }
//     }

//     // Filter redBankMarkets
//     const filteredRedBankMarkets = new Map<string, MarketV2Response>()
//     for (const [denom, market] of redBankMarkets.entries()) {
//       if (!excludedDenoms.has(denom)) {
//         filteredRedBankMarkets.set(denom, market)
//       }
//     }

//     // Log filtered results
//     console.log('Filtered Oracle Price Sources:')
//     filteredOraclePriceSources.forEach((value, key) => {
